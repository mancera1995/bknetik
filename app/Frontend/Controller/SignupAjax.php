...
class SignupAjax extends FrontendAjax
{
    public function signup()
    {
        ...
        $checkIfCustomer = Customer::where( 'email', $email )->fetch();
    ...
    public function resend_activation_link()
    {
        ...
        $isActivated = Customer::getData( $customerId, 'pending_activation' );
        $activationLastSent = Customer::getData( $customerId, 'activation_last_sent', 0 );
