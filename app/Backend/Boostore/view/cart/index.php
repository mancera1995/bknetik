...
<?php if ( ! empty( $parameters[ 'items' ] ) ): ?>
            ...
            <div class="col-lg-8 mb-4 fs_data_table_wrapper">
                ...
                <table class="fs_data_table elegant_table">
                    <thead>
                        <tr>
                            <th></th>
                            <th style="text-align: left; width: 50%;"><?= bkntc__( 'Addon') ?></th>
                            <th><?= bkntc__('Price') ?></th>
                            <th></th>
                        </tr>
                    </thead>
                        ...
                        <?php foreach ( $parameters[ 'items' ] AS $addon ):?>
                            <tr data-addon="<?php echo $addon[ 'slug' ] ?>">
                                ...
                                <td class="d-flex justify-content-end align-items-center">
                                    <button class="btn btn-danger remove-cart-item"><?= bkntc__('Remove') ?></button>
                                </td>
                            </tr>
                        <?php endforeach;?>
                    </tbody>
            ...
            <div class="col-lg-4">
                <div class="checkout_wrapper">
                    ...
                    <div class="checkout_wrapper_prices">
                        ...
                        <div class="checkout_price_item checkout_price_item_total">
                            <p class="checkout_price_item__total__title"> <?= bkntc__('Total'); ?> </p>
                            <p id="checkout_total_price" class="checkout_price_item__price checkout_price_item_total_price" data-total-price="<?= $totalPrice ?>">$<?php echo $totalPrice ?></p>
                        </div>
                    </div>
                    ...
                    <div id="coupon_wrapper" class="input-group my-2 mb-4">
                        ...
                        <div class="input-group-append">
                            <button id="apply_discount" class="btn h-100 btn-primary" type="button"><?= bkntc__('Apply') ?></button>
                        </div>
                    </div>
                        ...
                        <div id="coupon_applied_wrapper" class="input-group my-2 mb-4 justify-content-between" style="display:none; border-top: 1px solid #d7d9dc; padding-top: 10px;">
                            <label style="font-weight: 500; font-size: 14px; margin: 0;" id="coupon_label">
                                <?= bkntc__( 'Coupon applied' ) ?>:<span id="applied_coupon" style="font-weight: normal; margin-left: 8px;"></span>
                            </label>
                    ...
                    <button id="purchaseCart" class="btn w-100 btn-lg btn-success d-flex justify-content-center"><?= bkntc__('Proceed to checkout') ?></button>
                </div>
            </div>
        </div>
    </section>
    <!-- Filter panel -->
    <?php else: ?>
    <h1 class="display-1 d-flex justify-content-center"><?= bkntc__('Your Cart is empty') ?></h1>
    <?php endif; ?>
