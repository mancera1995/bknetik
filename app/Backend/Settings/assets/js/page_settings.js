(function ($)
{
	...
	$(document).ready(function ()
	{
		...
		$("#input_change_status_page_id, #input_time_restriction_to_change_appointment_status, #input_booknetic_signin_page_id, #input_booknetic_signup_page_id, #input_booknetic_forgot_password_page_id").select2({
			theme: 'bootstrap',
